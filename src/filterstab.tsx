            ...
            <ErrorBoundary errorMessage={errors.asText()}>
                <div>
                    ...
                    <div className="tabcontainer">
                        <div
                            className="tabpanel-with-header"
                            style={{ width: "700px" }}
                        >
                            ...
                            {this.filterNames().map((name) => (
                                <FilterView
                                    ...
                                    availableCoeffFiles={
                                        this.state.availableCoeffFiles
                                    }
                                    updateFilter={(update) =>
                                        this.updateFilter(name, update)
                                    }
                                    rename={(newName) =>
                                        this.renameFilter(name, newName)
                                    }
...
class FilterView extends React.Component<FilterViewProps, FilterViewState> {
    ...
    componentDidUpdate(
        prevProps: Readonly<FilterViewProps>,
        prevState: Readonly<FilterViewState>,
        snapshot?: any,
    ) {
            ...
            <Box
                ...
                title={
                    <ParsedInput
                        ...
                        asString={(x) => x}
                        parseValue={(newName) =>
                            isValidFilterName(newName) ? newName : undefined
                        }
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        {isConvolutionFileFilter(filter) && (
                            <MdiButton
                                ...
                                onClick={() =>
                                    this.setState({ filterFilePopupOpen: true })
                                }
                            />
                        )}
                        <DeleteButton
                    ...
                    <FilterParams
                        ...
                        setShowDefaults={() =>
                            this.setState({ showDefaults: true })
                        }
                    />
                </div>
                ...
                <FileSelectPopup
                    ...
                    header={
                        ...
                        >
                            <span>
                                Select a file containing filter coefficients.
                            </span>
                            <span>
                                For Raw filters, only single channel files are
                                supported.
                            </span>
                            <UploadButton
                    ...
                    onClose={() =>
                        this.setState({ filterFilePopupOpen: false })
                    }
                ...
                {this.state.showFilterPlot && this.state.data ? (
                    <div
                        style={{
                            width:
                                this.state.expandPlot &&
                                this.state.showFilterPlot
                                    ? "1100px"
                                    : "670px",
                        }}
                    >
                        <Chart
                            ...
                            onChange={this.plotFilterInitially}
                        />
                        <div
                            style={{
                                display: "inline-flex",
...
> {
        ...
        return (
            <div style={{ width: "100%", textAlign: "right" }}>
                ...
                {this.renderFilterParams(
                    filter.parameters,
                    errors.forSubpath("parameters"),
                )}
                {isConvolutionFileFilter(this.props.filter) &&
                    !this.props.showDefaults &&
                    this.hasHiddenDefaultValue() && (
                        <Button
                            text="..."
                ...
                {isGraphicEqualizer(filter) && (
                    ...
                    >
                        {filter.parameters.gains.map(
                            (gain: number, index: number, gains: [number]) => (
                                <div
                                    key={"eqslider" + index}
                                    style={{
                                        display: "flex",
                                ...
                                >
                                    ...
                                    >
                                        {this.eqBandFrequency(
                                            filter.parameters.freq_min,
                                            filter.parameters.freq_max,
                                            gains.length,
                                            index,
                                        )}
                                    </div>
                        ...
                        >
                            <AddButton
                                tooltip="Add one band"
                                onClick={this.addBand}
                            />
                            <DeleteButton
                                tooltip="Remove one band"
                                onClick={this.removeBand}
                            />
                        </div>
                    </div>
                )}
    ...
    private filenameField(
        ...
        return (
            <TextOption
                ...
                onChange={(value) =>
                    this.props.updateFilter(
                        coeffFileNameUpdate(coeffDir, value),
                    )
                }
            />
        );
    ...
    parameterInfos: {
        ...
        attenuate_mid: {
            ...
            desc: "attenuate_mid",
            tooltip:
                "Attenuate midband instead of boosting extremes, avoids clipping when used with external volume control",
        },
        b0: {
            type: "float",
            desc: "b0",
        ...
        high_boost: {
            ...
            desc: "high_boost",
            tooltip:
                "Volume boost for high frequencies when volume is at reference_level - 20dB",
        },
        inverted: {
            type: "optional_bool",
            desc: "inverted",
            tooltip: "Invert signal",
        },
        length: {
            type: "int",
            desc: "length",
        ...
        low_boost: {
            ...
            desc: "low_boost",
            tooltip:
                "Volume boost for low frequencies when volume is at reference_level - 20dB",
        },
