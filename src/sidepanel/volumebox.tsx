...
export class VolumeBox extends React.Component<Props, State> {
    private volumePoller = new VolumePoller(
        (cdspVolume) => this.setState({ ...cdspVolume }),
        1000.0,
        2000.0,
    );
    ...
    componentDidUpdate(prevProps: Readonly<Props>, prevState: Readonly<State>) {
        ...
        let vol_changed =
            Math.round(volume * 10) !== Math.round(prevState.volume * 10);
        ...
        return (
                ...
                title={
                    <>
                        ...
                        <MdiButton
                            ...
                            highlighted={dim}
                            enabled={
                                (dim && volume <= maxVol - 20) ||
                                (!dim && volume >= minVol + 20)
                            }
            ...
            >
                ...
                <input
                    ...
                    id="volume"
                    onChange={(e) =>
                        this.changeVolume(e.target.valueAsNumber / 10.0)
                    }
                />
                <VuMeterGroup
                    title="OUT"
