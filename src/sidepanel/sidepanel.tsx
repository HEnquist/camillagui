    ...
    constructor(props: SidePanelProps) {
        ...
        this.state = {
            ...
            applyConfigAutomatically:
                props.guiConfig.apply_config_automatically,
        ...
        return (
            <Box title="CamillaDSP">
                ...
                >
                    ...
                    <div>
                        {status.rateadjust ? status.rateadjust.toFixed(4) : ""}
                    </div>
        ...
        return (
            ...
            >
                ...
                <div className="setting">
                    ...
                    >
                        <div className="setting-label-wide">
                            Apply automatically
                        </div>
                        <input
                ...
                <div className="two-column-grid">
                    <div
                        data-tooltip-html={
                            unsaved
                                ? "GUI has changes that have<br>not been saved to file"
                                : "All changes have been saved to file"
                        }
                        data-tooltip-id="main-tooltip"
