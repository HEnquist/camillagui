            ...
            <div className="configapp">
                ...
                {this.state.compactView ? (
                    <CompactView
                        ...
                        disableCompactView={() =>
                            this.setCompactViewEnabled(false)
                        }
                ...
                >
                    <TabList>
                        <Tab disabled={true}>
                            ...
                            <MdiButton
                                ...
                                tooltip={
                                    "Undo last change<br>" + undoRedo.undoDiff()
                                }
                                buttonSize="tiny"
                                style={{
                                    marginLeft: "10px",
                            ...
                            <MdiButton
                                ...
                                tooltip={
                                    "Redo last change<br>" + undoRedo.redoDiff()
                                }
                                buttonSize="tiny"
                                onClick={() =>
                                    this.setState((prevState) => ({
                        ...
                        <Tab>
                            Devices{" "}
                            {errors.hasErrorsFor("devices") && <ErrorIcon />}
                        </Tab>
                        <Tab>
                            Filters{" "}
                            {errors.hasErrorsFor("filters") && <ErrorIcon />}
                        </Tab>
                        <Tab>
                            Mixers{" "}
                            {errors.hasErrorsFor("mixers") && <ErrorIcon />}
                        </Tab>
                        <Tab>
                            Processors{" "}
                            {errors.hasErrorsFor("processors") && <ErrorIcon />}
                        </Tab>
                        <Tab>
                            Pipeline{" "}
                            {errors.hasErrorsFor("pipeline") && <ErrorIcon />}
                        </Tab>
                        <Tab>Files</Tab>
                        <Tab>Shortcuts</Tab>
                    </TabList>
                    ...
                    <TabPanel>
                        <FiltersTab
                            ...
                            channels={getCaptureDeviceChannelCount(
                    ...
                    <TabPanel>
                        <Shortcuts
                            ...
                            shortcutSections={
                                this.state.guiConfig.custom_shortcuts
                            }
                        />
                    </TabPanel>
                </Tabs>
