...
export function DiffPopup(props: {
  ...
  >
    ...
    <div style={{ height: '90vh', overflowY: 'auto', overflowX: 'clip', padding: '5px' }}>
...
function renderDiff(left_config: Config, right_config: Config, left_name: string, right_name: string) {
  ...
  const displayrows: DiffTableRow[] = [{ type: "header", label: "Comparing:", left: left_name, right: right_name }]
