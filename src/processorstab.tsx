                            ...
                            {this.processorNames().map((name) => (
                                <ProcessorView
                                    ...
                                    updateProcessor={(update) =>
                                        this.updateProcessor(name, update)
                                    }
                                    rename={(newName) =>
                                        this.renameProcessor(name, newName)
                                    }
                                    isFreeProcessorName={
                                        this.isFreeProcessorName
                                    }
            ...
            <Box
                ...
                title={
                    <ParsedInput
                        ...
                        asString={(x) => x}
                        parseValue={(newName) =>
                            isValidProcessorName(newName) ? newName : undefined
                        }
...
> {
                    ...
                    <div>
                        <label className="setting">
                            <span className="setting-label">
                                <div
                                    data-tooltip-html="Channels to monitor"
                        ...
                        <label className="setting">
                            <span className="setting-label">
                                <div
                                    data-tooltip-html="Channels to process"
                                    data-tooltip-id="main-tooltip"
                                >
                                    process_channels
                                </div>
    ...
    parameterInfos: {
        ...
        subsample_delay: {
            type: "bool",
            desc: "subsample_delay",
            tooltip: "Enable subsample delay",
        },
        delay_unit: {
            type: "enum",
            desc: "delay_unit",
